...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=70, val_begin=1, val_interval=2  # Fewer epochs for fine-tuning
)
...
param_scheduler = [
    dict(
        type='MultiStepLR',
        begin=0,
        end=70,  # change from 100 to 50
        by_epoch=True,
        milestones=[25, 50],  # change milestones
        gamma=0.1)
]
