...
# resume_from = 'work_dirs/uniformerv2-base-p16-res224_clip_8xb32-u8_kinetics700-rgb_transfer/epoch_38.pth'
...
model = dict(
    ...
    loss_weight=1.0, class_weight=[1.0, 1.0, 1.0, 0.3]  # Adjust class imbalance
    )
    ),
...
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=12, val_begin=1, val_interval=1)  # 50
val_cfg = dict(type='ValLoop')
test_cfg = dict(type='TestLoop')

# base_lr = 1e-5
base_lr = 3.3325e-06
# current_lr = 1.0414e-07
...
default_hooks = dict(
    checkpoint=dict(interval=1, max_keep_ckpts=20, save_optimizer=True, save_last=True), logger=dict(interval=100), visualization=dict(type='VisualizationHook',
