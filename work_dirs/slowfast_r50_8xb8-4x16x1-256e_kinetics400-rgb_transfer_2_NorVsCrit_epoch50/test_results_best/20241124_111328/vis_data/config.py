...
launcher = 'none'
load_from = 'work_dirs/slowfast_r50_8xb8-4x16x1-256e_kinetics400-rgb_transfer_2_NorVsCrit_epoch50/best_acc_top1_epoch_50.pth'
log_level = 'INFO'
...
train_cfg = dict(
    max_epochs=20, type='EpochBasedTrainLoop', val_begin=1, val_interval=2)
...
work_dir = 'work_dirs/slowfast_r50_8xb8-4x16x1-256e_kinetics400-rgb_transfer_2_NorVsCrit_epoch50/test_results_best'
